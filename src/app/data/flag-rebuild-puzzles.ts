...
export const FLAG_REBUILD_PUZZLES: FlagRebuildPuzzle[] = [
  ...
  },
  {
    ...
    palette: ['#ff3b30', '#1c8a49', '#f5f5f5', '#222222', '#ff0000', '#00732f', '#ffffff', '#000000'],
  ...
  },
  {
    ...
    targetPattern: 'horizontal-stripes',
    patternOptions: ['horizontal-stripes', 'vertical-stripes', 'left-band-horizontal'],
    targetColors: ['#ea2839', '#1a206d', '#ffd500', '#00a551'],
    palette: ['#ee4f5f', '#3d4389', '#ffe04b', '#28b670', '#ea2839', '#1a206d', '#ffd500', '#00a551'],
